...
Current release [1.2.1](https://github.com/warsnek/for-the-king-save-editor/releases/tag/1.2.1)

The editor is pretty simple to use, to start using it first download the latest version from the releases page, or [click here](https://github.com/warsnek/for-the-king-save-editor/releases/download/1.2.1/ForTheKingSaveGameEditor.1.2.1.zip).
